...
//ProjectsService podría considerarse como una especie de API para gestionar proyectos en tu aplicación Angular. Proporciona métodos para obtener proyectos individualmente, obtener todos los proyectos y filtrar proyectos basados en etiquetas específicas. 
  projects: Project [] = [
    ...
    {id:3, name: "Sample MERN ", pictures: ["../../../assets/landing.png","../../../assets/login.png","../../../assets/players.png","../../../assets/player.png","../../../assets/graph.png", ], projectLink:"https://github.com/ScouzPro/Scoutify", summary: "Complete project frontend & backend", description:"It is a complete project, join backend & frontend", tags: [Tag.ANGULAR, Tag.TYPESCRIPT,Tag.CSS, Tag.MONGODB]},
    {id:4, name: "Sample Blog ", pictures: ["../../../assets/blog.png","../../../assets/blog-login.png"], projectLink:"https://github.com/angarce25/TrueLoveFood", summary: "Project frontend & backend", description:"It is a blogs project, join backend & frontend", tags: [Tag.REACT, Tag.JAVASCRIPT,Tag.CSS, Tag.MYSQL]}
