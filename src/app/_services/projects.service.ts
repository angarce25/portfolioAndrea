...
//ProjectsService podría considerarse como una especie de API para gestionar proyectos en tu aplicación Angular. Proporciona métodos para obtener proyectos individualmente, obtener todos los proyectos y filtrar proyectos basados en etiquetas específicas. 
  projects: Project [] = [
    ...
    {id:2, name: "E-commerce", pictures: ["../../assets/project3.png"], projectLink: "https://github.com/angarce25/react-api", summary: "E-commerce created with React & Vite.", description:"This is a basic React project that uses the PokeAPI to display information about Pokémon.",tags: [Tag.REACT, Tag.JAVASCRIPT,Tag.CSS]},
    {id:3, name: "Scoutify", pictures: ["../../../assets/landing.png","../../../assets/login.png","../../../assets/players.png","../../../assets/player.png","../../../assets/graph.png", ], projectLink:"https://github.com/ScouzPro/Scoutify", summary: "Complete project frontend & backend", description:"It is a complete project, join backend & frontend", tags: [Tag.ANGULAR, Tag.TYPESCRIPT,Tag.CSS, Tag.MONGODB]},
    {id:4, name: "Blog ", pictures: ["../../../assets/blog.png","../../../assets/blog-login.png"], projectLink:"https://github.com/angarce25/TrueLoveFood", summary: "Project frontend & backend", description:"It is a blogs project, join backend & frontend", tags: [Tag.REACT, Tag.JAVASCRIPT,Tag.CSS, Tag.MYSQL]},
    {id:5, name: "Centro Deportivo CA ", pictures: ["../../../assets/project5.png"], projectLink:"https://github.com/angarce25/centro-deportivo-front", summary: "Project frontend & backend", description:"It is a complete project, join backend & frontend", tags: [Tag.REACT, Tag.JAVASCRIPT,Tag.tailwind, Tag.MONGODB]}
